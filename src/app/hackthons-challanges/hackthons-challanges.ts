...
@Component({
  selector: 'app-hackthons-challanges',
  standalone: true,
  imports: [
    CommonModule,
    MaterialModule,
  ...
  templateUrl: './hackthons-challanges.html',
  styleUrls: ['./hackthons-challanges.scss']
})
export class HackthonsChallanges implements OnInit, AfterViewInit, OnDestroy
{
  ngOnInit(): void {}
